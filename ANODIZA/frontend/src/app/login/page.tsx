    ...
    <main className="page-shell">
      <section className="card">
        ...
        <form onSubmit={handleSubmit}>
          <label>Empresa<input value={empresaSlug} onChange={(event) => setEmpresaSlug(event.target.value)} /></label>
        ...
        <p style={{ marginTop: 18 }}>Ainda nao tem conta? <Link href="/cadastro">Criar cadastro</Link></p>
      </section>
    </main>
  );
}
