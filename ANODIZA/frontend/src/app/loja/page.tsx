    ...
    <main className="dashboard">
      <aside className="sidebar">
        ...
        <nav style={{ display: "grid", gap: 10, marginTop: 24 }}>
          {pode("painel") && <button onClick={() => abrir("painel")}>Painel</button>}
          {pode("orcamentos") && <button onClick={() => abrir("orcamentos")}>Orçamentos</button>}
          {pode("clientes") && <button onClick={() => abrir("clientes")}>Clientes</button>}
          {isMaster && <button onClick={() => abrir("usuarios")}>Usuários</button>}
          {pode("produtos") && <button onClick={() => abrir("produtos")}>Produtos</button>}
          {pode("materiais") && <button onClick={() => abrir("materiais")}>Materiais</button>}
          {pode("tags") && <button onClick={() => abrir("tags")}>Tags</button>}
          {pode("ajustes") && <button onClick={() => abrir("ajustes")}>Ajustes</button>}
