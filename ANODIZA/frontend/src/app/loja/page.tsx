...
export default function LojaPage() {
  ...
  async function criarUsuario(event: React.FormEvent<HTMLFormElement>) {
    event.preventDefault();
    try { await apiPost("/api/loja/usuarios", { empresa_slug: empresaSlug, ...novoUsuario }); setNovoUsuario({ nome: "", email: "", perfil: "vendedor" }); await carregarUsuarios(empresaSlug); }
